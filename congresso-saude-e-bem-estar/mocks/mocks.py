...
palestra1 = Palestra(
    '7166198a-baf6-4e91-b144-942d818d4f42',
    'Qualidade de vida e bem-estar.',
    'A palestra "Qualidade de Vida e Bem-Estar" ministrada pelo Dr. Drauzio Varella é uma oportunidade valiosa de explorar as complexidades da saúde e do bem-estar humano. Com seu conhecimento vasto e acessível, o Dr. Drauzio aborda diversos aspectos que influenciam a qualidade de vida, desde hábitos saudáveis de alimentação e exercício físico até questões emocionais e sociais.\nAo longo da palestra, o Dr. Drauzio compartilha insights baseados em evidências científicas sobre como pequenas mudanças no estilo de vida podem ter um impacto significativo na saúde geral e no bem-estar emocional das pessoas. Ele também aborda a importância da prevenção de doenças, destacando a necessidade de exames regulares e cuidados preventivos.\nAlém disso, o Dr. Drauzio explora temas como o equilíbrio entre trabalho e vida pessoal, a importância do sono adequado e estratégias para lidar com o estresse cotidiano. Sua abordagem envolvente e inspiradora motiva os espectadores a assumirem o controle de sua saúde e a adotarem hábitos que promovam uma vida mais plena e saudável.',
    22,
    'Maio',
